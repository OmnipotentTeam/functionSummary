...
(function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            '<div class="bootstrap-table search-collapse">',
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        this.$header.find('tr').each(function () {
            ...
            $(this).find('th').each(function () {
                ...
                column.push($.extend({}, {
                    ...
                    titleTooltip: $(this).attr('static.img.background.title'),
        ...
        this.$el.find('>tbody>tr').each(function (y) {
            ...
            $(this).find('>td').each(function (x) {
                ...
                row['_' + field + '_title'] = $(this).attr('static.img.background.title');
            ...
            if (column.checkbox || column.radio) {
                ...
                text = that.options.cardView ? ['<div class="card-view">',
                    that.options.showHeader ? sprintf('<span class="title" %s>%s</span>', style,
                        getPropertyFromOther(that.columns, 'field', 'static.img.background.title', field)) : '',
    ...
    BootstrapTable.prototype.refreshColumnTitle = function (params) {
        if (!params.hasOwnProperty('field') || !params.hasOwnProperty('static.img.background.title')) {
            return;
        }
