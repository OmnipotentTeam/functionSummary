            ...
            tabClick: function (i, a, s, o) {
                ...
                t(".layui-tab").each(function () {
                    var s = t(this), o = s.children(".layui-tab-title"),
                        ...
                        r = t('<span style="height: 100%" class="layui-unselect layui-tab-bar" ' + c + "><i " + c + ' class="layui-icon">&#xe61a;</i></span>');
                ...
                i !== !0 && "tabmore" === t(i.target).attr("lay-stope") || (a.removeClass("layui-tab-more"), a.find(".layui-tab-bar").attr("static.img.background.title", ""))
            }, clickThis: function () {
