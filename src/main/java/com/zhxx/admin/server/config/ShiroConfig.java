package com.zhxx.admin.server.config;
...
import com.zhxx.admin.server.filter.LogoutFilter;
import com.zhxx.admin.server.filter.RestfulFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/student/initialization", "anon");
//		filterChainDefinitionMap.put("/answer/answerQuestion", "anon");

        filterChainDefinitionMap.put("/wechatparent/**", "anon");
        filterChainDefinitionMap.put("/wechatparent/**", "anon");
        filterChainDefinitionMap.put("/student/**", "anon");
        filterChainDefinitionMap.put("/answer/**", "anon");
        filterChainDefinitionMap.put("/grade/**", "anon");
        filterChainDefinitionMap.put("/information/**", "anon");
        filterChainDefinitionMap.put("/util/**", "anon");
        filterChainDefinitionMap.put("/imgFiles/**", "anon");
        
        filterChainDefinitionMap.put("/assess/**", "anon");
        filterChainDefinitionMap.put("/growth/**", "anon");
